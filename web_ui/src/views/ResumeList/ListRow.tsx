...
export const ListRow = (p: Props) => {
    return (
        <div className='grid rows-2 border-b-2 p-5 mt-5 rounded-md bg-slate-100'>
            ...
            <Link to={`/resumes/${p.id}`} className='row-start-1 row-end-3 col-start-2 col-end-3 ml-auto self-center border rounded pt-1 pr-2 pb-1 pl-2 text-sm font-semibold'>
                View
            </Link>
        </div>
    )
